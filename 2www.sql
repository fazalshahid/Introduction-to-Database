...
SELECT country,electoral_system,num_party, 
	CASE WHEN num_party='1' THEN 1 ELSE 0 END as single_party,
	CASE WHEN num_party='2_3' THEN 1 ELSE 0 END as two_to_three,
	CASE WHEN num_party='4_5' THEN 1 ELSE 0 END as four_to_five,
	CASE WHEN num_party='6+' THEN 1 ELSE 0 END as six_or_more
FROM Party_group
GROUP BY country,electoral_system,num_party,election_id;
